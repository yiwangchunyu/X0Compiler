...
{
       0,    37,    37,    41,    42,    43,    47,    52,    63,    64,
      68,    69,    73,    74,    78,    79,    80,    81,    82,    83,
      87,    88,    92,    96,   100,   104,   108,   109,   113,   114,
     118,   119,   123,   124,   125,   126,   127,   128,   132,   133,
     137,   138,   142,   143,   147,   148,   152,   153,   156
};
#endif
...
{
  "$end", "error", "$undefined", "ID", "NUM", "PLUS", "MINUS", "TIMES",
  "SLASH", "EQL", "NEQ", "LES", "LEQ", "GTR", "GEQ", "LPAREN", "RPAREN",
  "LBRACKETS", "RBRACKETS", "LBRACE", "RBRACE", "COMMA", "SEMICOLON",
  "PERIOD", "BECOMES", "MAIN", "IF", "ELSE", "WHILE", "WRITE", "READ",
  "DO", "CALL", "INT", "CHAR", "'+'", "'-'", "'*'", "'/'", "'&'", "'|'",
  "'^'", "'@'", "'~'", "'!'", "$accept", "program", "declaration_list",
  "declaration_stat", "type", "var", "statement_list", "statement",
  "if_stat", "while_stat", "write_stat", "read_stat", "compound_stat",
  "expression_stat", "expression", "simple_expr", "operator",
  "additive_expr", "additive_op", "term", "term_op", "factor", YY_NULLPTR
};
#endif
...
{
     -23,    -7,    17,   -25,   -71,   -71,   -71,   -25,   -71,    19,
     -71,    10,    -6,     6,   -71,     0,   -71,   -71,   -71,    20,
      28,     0,    23,    21,   -71,   -71,   -71,   -71,   -71,   -71,
     -71,    22,   -71,    84,    11,   -71,    42,   -71,     0,    31,
      38,     0,     0,    26,    27,     0,   -71,   -71,   -71,   -71,
     -71,   -71,   -71,   -71,   -71,     0,     0,   -71,   -71,     0,
      32,    33,   -71,   -71,    36,    39,   -71,   -71,   -71,   -71,
      15,    11,   -71,    34,   -71,    58,    58,   -71,    43,   -71,
      58,   -71
};
...
{
       0,     0,     0,     5,     1,     8,     9,    13,     4,     0,
       3,     0,     0,    10,    48,     0,    13,     2,    27,     0,
       0,     0,     0,    47,    12,    14,    15,    17,    16,    18,
      19,     0,    29,    30,    38,    42,     0,     6,     0,     0,
       0,     0,     0,     0,     0,     0,    26,    40,    41,    36,
      37,    33,    35,    32,    34,     0,     0,    44,    45,     0,
       0,     0,    46,    25,     0,     0,    23,    24,    28,    47,
      31,    39,    43,     0,    11,     0,     0,     7,    21,    22,
       0,    20
};
...
{
     -71,   -71,   -71,    47,   -71,   -22,    49,   -70,   -71,   -71,
     -71,   -71,   -71,   -71,   -14,   -71,   -71,     4,   -71,     7,
     -71,    12
};
...
{
      -1,     2,     7,     8,     9,    23,    11,    24,    25,    26,
      27,    28,    29,    30,    31,    32,    55,    33,    56,    34,
      59,    35
};
...
{
      44,    39,     1,    13,    14,    78,    79,    43,     5,     6,
      81,    36,     3,    13,    14,    15,    37,     4,    57,    58,
      47,    48,    12,    38,    61,    15,    13,    64,    65,    16,
      17,    68,    18,    69,    69,    41,    19,    69,    20,    21,
      22,    13,    14,    42,    46,    45,    60,    62,    66,    67,
      73,    74,    75,    15,    10,    76,    77,    16,    63,    70,
      18,    13,    14,    71,    19,    40,    20,    21,    22,     0,
      80,    72,     0,    15,     0,     0,     0,    16,     0,     0,
      18,     0,     0,     0,    19,     0,    20,    21,    22,    47,
      48,     0,     0,    49,    50,    51,    52,    53,    54
};

static const yytype_int8 yycheck[] =
{
      22,    15,    25,     3,     4,    75,    76,    21,    33,    34,
      80,    17,    19,     3,     4,    15,    22,     0,     7,     8,
       5,     6,     3,    17,    38,    15,     3,    41,    42,    19,
      20,    45,    22,    55,    56,    15,    26,    59,    28,    29,
      30,     3,     4,    15,    22,    24,     4,    16,    22,    22,
      18,    18,    16,    15,     7,    16,    22,    19,    20,    55,
      22,     3,     4,    56,    26,    16,    28,    29,    30,    -1,
      27,    59,    -1,    15,    -1,    -1,    -1,    19,    -1,    -1,
      22,    -1,    -1,    -1,    26,    -1,    28,    29,    30,     5,
       6,    -1,    -1,     9,    10,    11,    12,    13,    14
};
...
{
       0,    25,    46,    19,     0,    33,    34,    47,    48,    49,
      48,    51,     3,     3,     4,    15,    19,    20,    22,    26,
      28,    29,    30,    50,    52,    53,    54,    55,    56,    57,
      58,    59,    60,    62,    64,    66,    17,    22,    17,    59,
      51,    15,    15,    59,    50,    24,    22,     5,     6,     9,
      10,    11,    12,    13,    14,    61,    63,     7,     8,    65,
       4,    59,    16,    20,    59,    59,    22,    22,    59,    50,
      62,    64,    66,    18,    18,    16,    16,    22,    52,    52,
      27,    52
};
...
#line 41 "compiler.y" /* yacc.c:1646  */
    {printf("declaration_list declaration_stat\n");}
